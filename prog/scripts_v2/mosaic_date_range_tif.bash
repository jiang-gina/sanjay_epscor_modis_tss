...
if [ $# != 4 ];then
	...
	echo "Four input parameters: start_date(yyyy.mm.dd), end_date(yyyy.mm.dd), data_raw_dir, data_out_dir"
...
if [ ! -d "$data_raw_dir" ]; then
	echo "data_raw_dir does not exist"
	exit 1
fi
...
do
    ...
    src_dir=$data_raw_dir/$yyyy1/$mm1/$yyyydotmmdotdd
    des_dir=${data_out_dir}/$yyyy1/$mm1/$yyyydotmmdotdd
